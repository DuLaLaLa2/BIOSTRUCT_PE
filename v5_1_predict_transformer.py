...
from v5_1_data import load_graph_sequences
from v5_1_metrics import evaluate_metrics, predict_sequences
from v5_1_struct_transformer import build_model_from_config

# Edit these values in VSCode, then click Run.
MODEL_PATH = "v5_1_best_struct_transformer.pt"
DATA_PATH = "117.pt"
OUTPUT_PATH = "v5_1_prediction_results.npz"
...
def main() -> None:
    ...
    if not isinstance(checkpoint, dict) or "model_state_dict" not in checkpoint:
        raise ValueError("MODEL_PATH is not a valid v5_1 checkpoint.")
