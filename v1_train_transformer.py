...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train v1 RoPE + structural-bias Transformer for residue RNA-binding prediction."
    )
    parser.add_argument("--train-data", default="495.pt")
    parser.add_argument("--test-data", default="117.pt")
    parser.add_argument("--save-model", default="v1_best_struct_transformer.pt")
        ...
        if val_mcc > best_val_mcc:
            ...
            save_checkpoint(
                args.save_model,
                {
                    ...
                    "pos_weight": pos_weight,
                    "architecture": (
                        "v1 RoPE Transformer with clipped relative sequence bias and "
