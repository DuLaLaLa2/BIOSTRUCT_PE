...
from v5_1_struct_transformer import build_model_from_config, checkpoint_model_config

# Edit these values in VSCode, then click Run.
TRAIN_DATA_PATH = "495.pt"
SAVE_MODEL_PATH = "v5_1_best_struct_transformer.pt"
...
USE_STRUCT_PEG = True
STRUCT_PEG_HIDDEN_DIM = 128
STRUCT_PEG_TOP_K = 16
STRUCT_PEG_CUTOFF = 10.0
STRUCT_PEG_SCALE = 0.05
...
def get_default_train_config() -> Dict[str, object]:
    return {
        ...
        "USE_STRUCT_PEG": USE_STRUCT_PEG,
        "STRUCT_PEG_HIDDEN_DIM": STRUCT_PEG_HIDDEN_DIM,
        "STRUCT_PEG_TOP_K": STRUCT_PEG_TOP_K,
        "STRUCT_PEG_CUTOFF": STRUCT_PEG_CUTOFF,
        "STRUCT_PEG_SCALE": STRUCT_PEG_SCALE,
        "LOSS_NAME": LOSS_NAME,
...
def run_training(config_overrides: Optional[Dict[str, object]] = None) -> Dict[str, object]:
    ...
    max_relative_position = int(cfg["MAX_RELATIVE_POSITION"])
    ...
    use_struct_peg = bool(cfg["USE_STRUCT_PEG"])
    struct_peg_hidden_dim = int(cfg["STRUCT_PEG_HIDDEN_DIM"])
    struct_peg_top_k = int(cfg["STRUCT_PEG_TOP_K"])
    struct_peg_cutoff = float(cfg["STRUCT_PEG_CUTOFF"])
    struct_peg_scale = float(cfg["STRUCT_PEG_SCALE"])
        ...
        if val_mcc > best_val_mcc:
            ...
            save_checkpoint(
                save_model_path,
                {
                    ...
                    "pos_weight": pos_weight,
                    "architecture": (
                        "v5_1 StructPEG Transformer with residue-level "
                        "structure-conditional positional encoding"
                    ),
                },
            )
        else:
